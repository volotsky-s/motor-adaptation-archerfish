...
runMCMC = function( datFrm , yName="y" , x1Name="x1" , x2Name="x2" ,
  ...
  yEpochMean = c(mean(y[x1==1]), mean(y[x1==2]), mean(y[x1==3]), mean(y[x1==4]), mean(y[x1==5]),
               mean(y[x1==6]), mean(y[x1==7]), mean(y[x1==8]), mean(y[x1==9]))
  
  ySubjectMean = c(mean(y[x2==1]), mean(y[x2==2]),  mean(y[x2==3]))
